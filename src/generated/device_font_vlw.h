...
inline constexpr std::size_t kDeviceFontVlwSize = 2818266U;
...
inline constexpr std::size_t kDeviceMetricFontVlwSize = 6327U;
...
inline constexpr std::size_t kDeviceTimeFontVlwSize = 14308U;
...
inline constexpr std::size_t kConfigPortalFontVlwSize = 17744U;
