...
inline constexpr std::size_t kDeviceFontVlwSize = 2331858U;
inline constexpr std::uint32_t kDeviceFontGlyphCount = 7542U;
inline constexpr std::uint32_t kDeviceFontPixelSize = 18U;
